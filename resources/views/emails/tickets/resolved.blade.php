...
<head>
    ...
    <title>Ticket Resolved - {{ $ticket->title }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <div class="message">
                @if($recipientType === 'creator')
                    <p>Your support ticket <strong>#{{ $ticket->uuid }}</strong> has been marked as resolved.</p>
                    <p>Our team has addressed the issue you reported. Please review the solution and let us know if you need any further assistance.</p>
                @elseif($recipientType === 'assignee')
                    <p>You resolved ticket <strong>#{{ $ticket->uuid }}</strong>.</p>
                @elseif($recipientType === 'support')
                    <p>Ticket <strong>#{{ $ticket->uuid }}</strong> has been resolved by {{ $ticket->assignee?->name ?? 'a team member' }}.</p>
                @else
                    <p>Ticket <strong>#{{ $ticket->uuid }}</strong> has been resolved.</p>
                @endif
            </div>
            ...
            <div class="ticket-details">
                ...
                <table class="detail-table">
                    ...
                    @if($ticket->assignee)
                    <tr>
                        <td class="detail-label">Resolved By:</td>
                    ...
                    <tr>
                        <td class="detail-label">Resolved:</td>
            ...
            <div class="info-box">
                <h4>What's Next?</h4>
                <p>If the issue has been fully resolved to your satisfaction, the ticket will be automatically closed after a few days. If you need additional assistance, simply reply to this ticket and it will be reopened.</p>
            </div>
            @endif
            ...
            <div class="message">
                @if($recipientType === 'creator')
                    ...
                    <p style="text-align: center;">We are pleased we could help resolve your issue.</p>
                @endif
            </div>
        </div>
