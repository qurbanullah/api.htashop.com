...
<head>
    ...
    <title>Ticket Closed - {{ $ticket->title }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="email-container">
        ...
        <div class="header">
            <div class="icon">✕</div>
            <h1>Ticket Closed</h1>
            <p>Support ticket has been closed</p>
        </div>
        ...
        <div class="content">
            ...
            <div class="message">
                @if($recipientType === 'creator')
                    <p>Your support ticket <strong>#{{ $ticket->uuid }}</strong> has been closed.</p>
                    <p>We hope we were able to resolve your issue. If you need additional assistance with this matter, you can reopen the ticket by replying.</p>
                @elseif($recipientType === 'assignee')
                    <p>Ticket <strong>#{{ $ticket->uuid }}</strong> that was assigned to you has been closed.</p>
                @elseif($recipientType === 'support')
                    <p>Ticket <strong>#{{ $ticket->uuid }}</strong> has been closed.</p>
                @else
                    <p>Ticket <strong>#{{ $ticket->uuid }}</strong> has been closed.</p>
                @endif
            </div>
            ...
            <div class="ticket-details">
                ...
                <table class="detail-table">
                    ...
                    @if($ticket->assignee)
                    <tr>
                        <td class="detail-label">Handled By:</td>
                    ...
                    <tr>
                        <td class="detail-label">Closed:</td>
            ...
            <div class="info-box">
                ...
                <p>If you have a new issue or need further assistance, feel free to open a new support ticket. You can also reopen this ticket if the issue persists.</p>
            </div>
            @endif
            ...
            <div class="message">
                @if($recipientType === 'creator')
                    ...
                    <p style="text-align: center;">We are always here to help whenever you need us.</p>
                @endif
            </div>
        </div>
