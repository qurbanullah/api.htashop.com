...
<head>
    ...
    <title>Ticket Unassigned - {{ $ticket->title }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="email-container">
        ...
        <div class="header">
            ...
            <h1>Ticket Unassigned</h1>
            <p>Support ticket requires attention</p>
        </div>
        ...
        <div class="content">
            <div class="greeting">
                ...
                @elseif($recipientType === 'previous_assignee')
                    {{ $previousAssignee?->name ?? 'Team Member' }},
            ...
            <div class="message">
                @if($recipientType === 'creator')
                    <p>Your support ticket <strong>#{{ $ticket->uuid }}</strong> has been unassigned and is now awaiting reassignment to a support team member.</p>
                @elseif($recipientType === 'previous_assignee')
                    <p>You have been unassigned from ticket <strong>#{{ $ticket->uuid }}</strong>. The ticket is now available for reassignment.</p>
                @elseif($recipientType === 'support')
                    <p>Ticket <strong>#{{ $ticket->uuid }}</strong> has been unassigned and requires attention from the support team.</p>
                @else
                    <p>Ticket <strong>#{{ $ticket->uuid }}</strong> has been unassigned.</p>
                @endif
            </div>
            ...
            <div class="ticket-details">
                ...
                <table class="detail-table">
                    ...
                    <tr>
                        ...
                        <td class="detail-value">{{ $ticket->user?->name ?? 'Unknown' }}</td>
                    </tr>
                    <tr>
            ...
            <div class="message">
                @if($recipientType === 'creator')
                    <p>We apologize for any inconvenience. Your ticket will be reassigned to a team member shortly.</p>
                @elseif($recipientType === 'support')
                    <p>Please review and reassign this ticket at your earliest convenience.</p>
                @endif
            </div>
        </div>
