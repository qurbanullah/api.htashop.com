...
<body>
    ...
    <div class="content">
        <p style="margin-top: 0;">Hi {{ $email }},</p>
        ...
        <p style="margin-top: 4px;">
            <a href="{{ $siteUrl }}" class="btn">Visit {{ parse_url($siteUrl, PHP_URL_HOST) ?: 'the store' }}</a>
        </p>
    </div>
    ...
    <div class="footer">
        ...
        <p style="margin: 0;">© {{ date('Y') }} HTAShop · {{ parse_url($siteUrl, PHP_URL_HOST) }}</p>
    </div>
</body>
</html>
