 ...
 * @link     https://github.com/qurbanullah
 */
class UserSearchBySlugAction
{
    /**
     * Find User by slug with all necessary relationships
     *
     ...
     */
    public function handle($slug, bool $withTrashed = false): ?User
    {
        return DB::transaction(
            function () use ($slug, $withTrashed) {
