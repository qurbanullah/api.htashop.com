...
class LtypeSortAction
{
     ...
     */
    public function handle($modelId, $newPosition): Ltype
    {
        $model = (new LtypeSearchByIdAction)->handle($modelId);
        $currentPostion = $model->sorting;

        $modelNeedToBeShifted = Ltype::whereBetween(
            'sorting',
            [
