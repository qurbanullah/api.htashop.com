...
class TutorialUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'type' => ['sometimes', 'required', 'string', Rule::in(array_column(TutorialTypeEnum::cases(), 'value'))],
            ...
            'status' => ['sometimes', 'required', 'string', Rule::in(array_column(TutorialStatusEnum::cases(), 'value'))],
